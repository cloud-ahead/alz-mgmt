...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "l.atanassov@outlook.com"
    ...
    # IP Ranges Primary
    # Regional Address Space: 10.128.0.0/16
    primary_hub_address_space                          = "10.128.0.0/16"
    primary_hub_virtual_network_address_space          = "10.128.0.0/22"
    primary_firewall_subnet_address_prefix             = "10.128.0.0/26"
    primary_firewall_management_subnet_address_prefix  = "10.128.0.192/26"
    primary_bastion_subnet_address_prefix              = "10.128.0.64/26"
    primary_gateway_subnet_address_prefix              = "10.128.0.128/27"
    primary_private_dns_resolver_subnet_address_prefix = "10.128.0.160/28"
  }
...
management_group_settings = {
  ...
  subscription_placement = {
    ...
    bootstrap = {
      subscription_id       = "$${subscription_id_bootstrap}"
      management_group_name = "management"
    }
  }
